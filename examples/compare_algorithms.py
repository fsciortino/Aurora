...
rvol_grid, pro_grid, qpr_grid, prox_param = aurora.grids_utils.create_radial_grid(asim.namelist,plot=True)

# Visualize time resolution
time_grid, save_grid = aurora.grids_utils.create_time_grid(asim.namelist['timing'], plot=True)
...
aurora.plot_tools.slider_plot(
    asim.rvol_grid, asim.time_out, nz.transpose(1,0,2),
