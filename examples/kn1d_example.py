...
n0 = interp1d(kn1d_res["kn1d_profs"]["rhop"], kn1d_res["kn1d_profs"]["n0"] * 1e-6)(
    kp["Te"]["rhop"]
)
kp["n0"]["vals"] = n0[
    None, :
]  # need to set to (time,radius) grid, here time-independent
...
asim_cxr.rad = aurora.compute_rad(
    imp,
...
rad_model = aurora.radiation_model(
    imp, rhop, ne, Te, geqdsk, nz_cm3=nz_interp, plot=True
)
rad_model_cxr = aurora.radiation_model(
    imp, rhop, ne, Te, geqdsk, nz_cm3=nz_cxr_interp, n0_cm3=n0, Ti_eV=Ti
)
